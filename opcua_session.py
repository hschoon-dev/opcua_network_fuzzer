import struct
from construct import Int32ul, Int16ul, Int8ul, Int64ul, Float64l, Bytes, PaddedString, Array, If, IfThenElse, Switch, GreedyBytes, Peek
...
def my_recv(s, prev=b""):
    ...
    #if message_size < 8:
    #    raise ValueError("Received payload is smaller than expected")
